...
Projeto realizado por meio do curso de Desenvolvimento Web da Trybe. Projeto visando testar as habilidades com E6, Higher Order Functions e testes. 
O objetivo do projeto foi desenvolver funções que buscassem informações sobre os animais do zoológico, tais como: espécie e local de origem. Além disso, buscar dados sobre as pessoas que colaboram com a manutenção e cuidado do zoológico. 
Houve também a necessidade de implementar testes para contribuir com a escrita de códigos mais confiáveis e com boa performance.
...
# 15. Obtenha ao menos 100% de cobertura de testes na função `getOpeningHours`.
